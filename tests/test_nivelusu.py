...
try:
    ...
    contrasena_input.send_keys("ContraseñaSegura123")

    # Seleccionar el nivel de usuario usando Select
    nivel_usuario_select = Select(driver.find_element(By.NAME, "nivel-usuario"))
    nivel_usuario_select.select_by_value("")  # Cambia "1" por el valor correspondiente al nivel de usuario que deseas
